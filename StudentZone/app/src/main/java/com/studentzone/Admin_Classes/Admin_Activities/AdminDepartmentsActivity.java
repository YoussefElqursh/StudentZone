...
public class AdminDepartmentsActivity extends AppCompatActivity {
    Button btn_add_new_department;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_departments);

        btn_add_new_department = findViewById(R.id.activity_admin_depatrments_btn_add);

        btn_add_new_department.setOnClickListener(new View.OnClickListener() {
            @Override
